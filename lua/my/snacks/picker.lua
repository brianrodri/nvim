...
return {
  ...
  keymaps = {
    ...
    { "<leader>fc", function() require("snacks.picker").files({ dirs = { my_env.nvim_config_dir } }) end, desc = "Config Files (nvim)" },
    { "<leader>fC", function() require("snacks.picker").files({ dirs = { my_env.nvim_config_dir, my_env.dot_config_dir } }) end, desc = "Config Files (all)" },
    ...
    { "<leader>fR", function() require("snacks.picker").recent({ filter = { cwd = true }}) end, desc = "Recent Files (cwd)" },
    -- Grep
    ...
    { "<leader>sw", function() require("snacks.picker").grep_word() end, desc = "Word/Selection (Root Dir)", mode = { "n", "x" } },
    { "<leader>sW", function() require("snacks.picker").grep_word({ root = false }) end, desc = "Word/Selection (cwd)", mode = { "n", "x" } },
    -- search
