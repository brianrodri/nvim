...
return {
...

  {
    ...
    opts = function(_, opts)
      vim.api.nvim_set_hl(0, "my.obsolete", { fg = "#4F5B58", strikethrough = true })

      opts = vim.tbl_deep_extend("force", opts or {}, { checkbox = { custom = {} } })
      ...
      return vim.tbl_deep_extend("force", opts, {
        ...
        checkbox = {
          ...
          custom = {
            ...
            canceled    = { raw = "[-]", rendered = "󰛲 ", highlight = "my.obsolete", scope_highlight = "my.obsolete" },
